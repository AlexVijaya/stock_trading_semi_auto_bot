...
if __name__ == "__main__":
    name_of_folder_where_plots_will_be = 'current_false_breakout_of_atl_by_two_bars_entry_point_next_day'
    ...
    table_where_levels_formed_by_false_breakout_of_atl_are_stored = "current_false_breakout_of_atl_by_two_bars_position_entry_next_day"
    try:
