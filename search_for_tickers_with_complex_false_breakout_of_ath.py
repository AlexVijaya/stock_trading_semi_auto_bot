                                                ...
                                                for number_of_step_in_searching_for_cfb in range(0,
                                                    ...
                                                    try:
                                                        ...
                                                        if open_of_third_bar_after_breakout_and_more > current_ath_in_iteration_over_numpy_array and \
                                                            ...
                                                            #add open of bar after last false breakout bar
                                                            open_of_bar_after_third_bar_after_breakout_and_more=np.nan
                                                            try:
                                                                open_of_bar_after_third_bar_after_breakout_and_more = \
                                                                    table_with_ohlcv_data_df_slice_numpy_array[
                                                                        number_of_last_row_in_np_array_row_slice + 2 + number_of_step_in_searching_for_cfb+1][
                                                                        1]
                                                                if open_of_bar_after_third_bar_after_breakout_and_more>close_of_third_bar_after_breakout_and_more:
                                                                    break
                                                            except:
                                                                pass
                                                            ...
                                                            df_with_level_atr_bpu_bsu_etc.loc[
                                                                0, "open_of_bar_after_third_bar_after_breakout_and_more"] = open_of_bar_after_third_bar_after_breakout_and_more
