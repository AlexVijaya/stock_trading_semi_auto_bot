...
def plot_ohlcv_charts_with_false_breakout_of_ath_situations_entry_point_next_day (name_of_folder_where_plots_will_be,
    ...
    for row_with_level_formed_by_ath_and_ready_for_false_breakout in range ( 0 , len ( table_of_tickers_with_false_breakout_of_ath_df ) ):
        ...
        try:
            ...
            stock_ticker = table_of_tickers_with_false_breakout_of_ath_df.loc[row_with_level_formed_by_ath_and_ready_for_false_breakout , 'ticker']
            ...
            short_name = table_of_tickers_with_false_breakout_of_ath_df.loc[row_with_level_formed_by_ath_and_ready_for_false_breakout , 'short_name']
            print ( "stock_ticker=" , stock_ticker )
            ...
            open_of_bar_before_false_breakout=table_of_tickers_with_false_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_false_breakout , 'open_of_bar_before_false_breakout']
            high_of_bar_before_false_breakout = table_of_tickers_with_false_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_false_breakout , 'high_of_bar_before_false_breakout']
            low_of_bar_before_false_breakout = table_of_tickers_with_false_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_false_breakout , 'low_of_bar_before_false_breakout']
            close_of_bar_before_false_breakout = table_of_tickers_with_false_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_false_breakout , 'close_of_bar_before_false_breakout']
            volume_of_bar_before_false_breakout = table_of_tickers_with_false_breakout_of_ath_df.loc[
                row_with_level_formed_by_ath_and_ready_for_false_breakout , 'volume_of_bar_before_false_breakout']
            ...
            print ( f'{stock_ticker} on {exchange} is number {row_with_level_formed_by_ath_and_ready_for_false_breakout + 1} '
            ...
            try:
                ...
                fig.update_layout ( height = 1500 * number_of_charts ,
                                    ...
                                    title_text = f'{stock_ticker} '
                                                 f'on {exchange} with level formed by ath={ath} with pre_false_breakout_bar on {human_date_of_pre_false_breakout_bar}'+'<br> '
                                                 f'"{short_name}"',
                                    font = dict (
                ...
                take_profit_when_stop_loss_is_technical=\
                    round(take_profit_when_stop_loss_is_technical,2)
                distance_between_technical_stop_loss_and_sell_order_in_atr = \
...
##########################################################
                ...
                try:
                    fig.add_annotation ( text =
                                         ...
                                         f"{close_of_bar_before_false_breakout}, {int(volume_of_bar_before_false_breakout)}"
...
if __name__=="__main__":
    name_of_folder_where_plots_will_be = 'current_false_breakout_of_ath_entry_point_next_day'
    db_where_ohlcv_data_for_stocks_is_stored="stocks_ohlcv_daily"
    db_where_levels_formed_by_false_breakout_of_ath_are_stored="levels_formed_by_highs_and_lows_for_stocks"
    table_where_levels_formed_by_false_breakout_of_ath_are_stored = "current_false_breakout_situations_of_ath_position_entry_next_day"
    try:
