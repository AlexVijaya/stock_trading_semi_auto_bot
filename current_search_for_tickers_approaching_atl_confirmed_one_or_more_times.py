...
def search_for_tickers_with_rebound_situations(db_where_ohlcv_data_for_stocks_is_stored,
    ...
    for stock_name in list_of_tables_in_ohlcv_db:
        ...
        try:
            ...
            truncated_high_and_low_table_with_ohlcv_data_df = truncated_high_and_low_table_with_ohlcv_data_df.tail(252 * 5)
...
######################################################
            ...
            if len(ohlcv_df_with_low_equal_to_atl_slice)>1:
                ...
                if (row_number_of_bsu-(252*5))>=0:
                    row_number_of_first_row_to_check_five_year_non_exeed_atl=row_number_of_bsu-252*5
                    list_of_lows=\
                        list(table_with_ohlcv_data_df.loc[
                             row_number_of_first_row_to_check_five_year_non_exeed_atl:,"low"])
                ...
                try:
                    ...
                    list_of_stock_tickers_with_last_low_equal_to_atl_and_equal_to_limit_level = \
                        append_gerchik_and_co_mark_to_stock_and_add_it_to_list_if_stock_has_cfd_on_gerchik_and_co(
                            stock_name, list_of_stock_tickers_with_last_low_equal_to_atl_and_equal_to_limit_level)
                except:
                    traceback.print_exc()
