            ...
            try:
                ...
                try:
                    fig.add_annotation ( text =
                                         ...
                                         # f" | open_of_next_day_after_false_breakout={open_of_bar_next_day_after_false_breakout_bar}"
                                         # 
...
if __name__ == "__main__":
    name_of_folder_where_plots_will_be = 'current_false_breakout_of_atl_entry_point_next_day'
    ...
    table_where_levels_formed_by_false_breakout_of_atl_are_stored = "current_false_breakout_situations_of_atl_position_entry_next_day"
    try:
